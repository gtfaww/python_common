...
def aes_encrypt(key, aes_str):
    ...
    # 加密结果
    encrypt_aes = str(encrypt_aes, encoding='utf-8', errors='ignore')  # 解码
...
if __name__ == '__main__':
    ...
    encryption_result = aes_encrypt(bytearray(finalKey), "hello world")
    print(encryption_result)
    ...
    dncrypt = aes_dncrypt(bytearray(finalKey), encryption_result)
    print(dncrypt)
